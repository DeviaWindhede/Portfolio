...
import { ShitboxComponent } from './articles/shitbox/shitbox.component';

export const routes: Routes = [
    { path: '', redirectTo: '/dashboard', pathMatch: 'full' },
    { path: 'dashboard', component: DashboardComponent, title: 'Devia Windhede' },
    { path: 'group-projects', component: GameProjectsComponent, title: 'TGA Projects' },
    ...
    { path: 'shitbox', component: ShitboxComponent, title: 'sHitbox' },
